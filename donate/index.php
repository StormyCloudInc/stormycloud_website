...
<style>
.custom-heading {
    font-size: 1.5em; /* Adjust size to match the h2 */
    margin: 0; /* Adjust margin to match the h2 */
...
<body id="donate">
  ...
  <div class="container">
    <div class="inner">
     ...
     <p></p>
      <p>By donating to StormyCloud Inc you are supporting the defense of Internet access as a fundamental human right. Your contribution ensures electronic privacy, fosters unrestricted access to information, and promotes the free exchange of ideas across borders. Together, we can harness the power of an open and secure Internet to build stronger, more connected communities and drive positive global change.</p>

      <div class="crypto-container">
        <div class="crypto-item">
          <h3>Monero (XMR)</h3>
          <img src="../assets/images/xmr.png" width="150" height="150" alt="Monero QR Code">
          <div class="crypto-address" tabindex="0">45Gtj5tkhs4EsbnV7kkhMCRpbZUdqCQqR5qmLFVLAvbFCYaPL4pFbBkEBLJ7beHqkiJxdTBkPwFsT5EMu5jDrYBHPjQzPuv</div>
        </div>
        <div class="crypto-item">
          <h3>Bitcoin (BTC)</h3>
          <img src="../assets/images/btc.png" width="150" height="150" alt="Bitcoin QR Code">
          <div class="crypto-address" tabindex="0">1NDRuQNyJZmYK4AJwve1aqa56ntuXpbyA7</div>
        </div>
        <div class="crypto-item">
          <h3>Ethereum (ETH)</h3>
          <img src="../assets/images/eth.png" width="150" height="150" alt="Ethereum QR Code">
          <div class="crypto-address" tabindex="0">0x07FA04Bd6660dCB8f0C9338F37aBdA67A656CA2F</div>
        </div>
        <div class="crypto-item">
          <h3>Litecoin (LTC)</h3>
          <img src="../assets/images/ltc.png" width="150" height="150" alt="Litecoin QR Code">
          <div class="crypto-address" tabindex="0">LULvg4mJc9Y37hU3sbVTMxJAPyNwyCJHw6</div>
        </div>
      </div>

      <div class="donation-widgets">
...
<div class="widget widget4">
            ...
            <p class="text-to-donate">Text "STORMY" to 53-555 to donate via SMS. Your support helps us maintain and improve our services!</p>
          </div>
  </div>
